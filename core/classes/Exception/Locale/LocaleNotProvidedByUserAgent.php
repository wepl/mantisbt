...
/**
 * Locale Not Provided By User Agent Exception
 * @package MantisBT
 * @subpackage classes
 */
class LocaleNotProvidedByUserAgent extends ExceptionAbstract
{
    ...
    public function __construct($p_parameters = null, \Exception $p_previous = null)
    {
        if ($p_parameters === null) {
            $t_message = _('An Accept-Language header was expected from your browser, but none was received.');
        } else {
            $t_message = vsprintf( _('An Accept-Language header was expected from your browser, but none was received.'), $p_parameters);
        }
