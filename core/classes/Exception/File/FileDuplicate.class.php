...
/**
 * File Duplicate Exception
 * @package MantisBT
 * @subpackage classes
 */
class FileDuplicate extends ExceptionAbstract
{
    /**
     * Constructor
    ...
    public function __construct($p_parameters = null, \Exception $p_previous = null)
    {
        if ($p_parameters === null) {
            $t_message = _('This is a duplicate file. Please delete the file first.');
        } else {
            $t_message = vsprintf( _('This is a duplicate file. Please delete the file first.'), $p_parameters);
        }
