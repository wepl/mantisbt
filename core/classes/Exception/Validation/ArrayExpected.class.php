...
class ArrayExpected extends ExceptionAbstract
{
    ...
    public function __construct($p_parameters = null, \Exception $p_previous = null)
    {
        if ($p_parameters === null) {
            $t_message = _('An array was expected but a string was received for %1$s.');
        } else {
            $t_message = vsprintf( _('An array was expected but a string was received for %1$s.'), $p_parameters);
        }
